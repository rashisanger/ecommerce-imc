...
const selectedProduct = {
    ...
    price: 120,
    originalPrice: 150,
    description: "This iis a stylish jacket",
    brand: "Puma",
    material: "Leather",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Red", "Black"],
    images: [
        { url: "https://picsum.photos/500/500?random1", altText: "Stylish Jacket 1" },
        { url: "https://picsum.photos/500/500?random2", altText: "Stylish Jacket 2" }
    ]
};

const similarProducts = [
    { _id:1, name: "Shri Tulsi", price: 100, images: [{url: shriTulsi}] },
    { _id:2, name: "Himalayan Berry", price: 100, images: [{url: himalayanBerry}] },
    { _id:3, name: "Aloe Vera Fibrous Juice", price: 100, images: [{url: aloeVeraJuice}] },
    { _id:4, name: "Aloe Jyoti", price: 100, images: [{url: aloeJyoti}] },
];
...
const ProductDetails = () => {
    ...
    const handleAddToCart = () => {
        if(!selectedSize || !selectedColor){
            toast.error("Please select a size and color before adding to the cart.", { duration: 1000 });
            return;
        }
                            ...
                            <div className='flex gap-2 mt-2'>
                                {selectedProduct.colors.map(color => (
                                    <button
                                        ...
                                        style={{ background: color.toLowerCase(), filter: "brightness(0.5)" }}
                                    ></button>
                                ))}
                            </div>
                        </div>
